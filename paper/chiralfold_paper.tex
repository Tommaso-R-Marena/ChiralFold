...
The complete verification dataset (1,678 rows --- 1,677 checkable residues plus one incomplete-backbone entry --- with raw N/C$_\alpha$/C/C$_\beta$ coordinates for every D-amino acid residue) is available at: \url{https://github.com/Tommaso-R-Marena/ChiralFold/blob/master/results/d_residue_verification.csv}
