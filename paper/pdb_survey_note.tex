...
The audit covers 12{,}573 D-amino acid C$_\alpha$ centers across 4{,}623 PDB entries; 12{,}544 (99.77\%) carry the expected D-chirality and 29 (0.23\%) carry L-chirality despite D-amino acid labels. Code-level coverage is summarized in Table~\ref{tab:coverage} (full table in \texttt{results/ccd\_code\_coverage\_summary.csv}). Five codes account for all 29 errors and define the ``error-prone'' set; nine codes are confirmed clean at zero errors and $>$91\% of their RCSB universe.
